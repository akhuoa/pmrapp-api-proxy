/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3831ad986dc6cd032419c62cfae7383c)
...
declare namespace Cloudflare {
	...
	interface Env {
		CORS_PROXY_API_URL: "https://pmr3.demo.physiomeproject.org";
		MODELS_URL: string;
		ALLOW_CORS_PROXY_URL_OVERRIDE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_PROXY_API_URL" | "MODELS_URL" | "ALLOW_CORS_PROXY_URL_OVERRIDE" | "ALLOWED_ORIGINS" | "API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
